...
clear_console()
msg  = "|=======================================================|\n"
msg += "|                Игра 'Морской бой'                     |\n"
msg += "| Можно играть с компьютером или выбрать бой 2х компов  |\n"
msg += "| Игрок 1 по выбору человек или компьютер               |\n"
msg += "| Игрок 2 играет за компьютер                           |\n"
msg += "| Игроки ходят по очереди                               |\n"
msg += "| На поле у компьютера корабли скрыты                   |\n"
msg += "| На поле человека корабли отображаются в момент атаки  |\n"
msg += "| Состояние полей:                                      |\n"
...
user1 = input("Настройка Игрок 1: Введи 1 если играет компьютер, иначе играет человек: ")

#Игровая логика
#Генерация поля Игрок 1
user_shutter = Field("Игрок 1 - людь", type='auto' if user1 == '1' else 'human')
...
while True:
    ...
    #если играют 2 компа то пауза, иначе нажми enter
    if user_shutter.type == 'auto' and user_target.type == 'auto':
        time.sleep(2)
    else:
